...
class HerosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hero" do
    assert_difference('Hero.count') do
      post heros_url, params: { hero: { category: @hero.category, email: @hero.email, nickname: @hero.nickname } }
    end
  ...
  test "should update hero" do
    patch hero_url(@hero), params: { hero: { category: @hero.category, email: @hero.email, nickname: @hero.nickname } }
